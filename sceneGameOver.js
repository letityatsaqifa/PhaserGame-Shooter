var sceneGameOver = new Phaser.Class({
    ...
    preload: function () {
        ...
        this.load.audio('snd_gameover', 'assets/audio/music_gameover.mp3');
    ...
    create: function () {
        ...
        const gameOverText = this.add.text(X_POSITION.CENTER, Y_POSITION.BOTTOM / 3.2, 'Game Over', {
            fontFamily: 'Arial',
            fontSize: 95,
            color: '#ff0000', // Merah
            align: 'center',
        ...
        if (this.snd_gameover == null) {
            this.snd_gameover = this.sound.add('snd_gameover', { loop: true });
        }
        ...
        if (musicState == 1) {
            if (!this.snd_gameover.isPlaying) {
